...
std::vector<CouplingParameter> readDynMatrices(const std::string &filename)
{
    ...
    while (getline(file, line))
    {
        ...
        param.D[0][0] = values[3];
        param.D[0][1] = values[4];
        param.D[0][2] = values[5];
        param.D[1][0] = values[6];
        param.D[1][1] = values[7];
        param.D[1][2] = values[8];
        param.D[2][0] = values[9];
        param.D[2][1] = values[10];
        param.D[2][2] = values[11];
