...
filename8x8 = "scripts/Data/set_pol_vec_input_output/eigenenergies_set_pol_vec_GP.txt"
...
S_matrix = retrieve_data_from_file("scripts/Data/set_pol_vec_input_output/eigenVectors_set_pol_vec_GP.txt")
...
plt.xticks(ticks=[0, 1], labels=[r'$\Gamma$', r'$P$'])
...
fig = plt.figure(figsize=(10/2.52, 5/2.52))  # Wider figure to accommodate both plots
...
ax1.set_xticks([0, 1])
ax1.set_xticklabels([r'$\Gamma$', r'$P$'])
...
axin1.set_ylim(1.6, 3)
axin1.set_xlim(0.05, 0.07)
axin1.set_xticks([])
ax2.indicate_inset_zoom(axin1, edgecolor="black")
#ax2.set_ylabel('dispersion relation (meV)')

plt.tight_layout()
plt.savefig('scripts/Figures/diag_double_GP.png', dpi=600)
plt.show()
