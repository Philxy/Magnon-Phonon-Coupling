...
filename8x8 = "scripts/Data/set_pol_vec_input_output/eigenenergies_set_pol_vec_GN.txt"

eigenenergies = retrieve_data_from_file(filename8x8)
eigenenergies.reverse()
...
ax1.set_xticks([0, 1])
ax1.set_xticklabels([r'$\Gamma$', r'$N$'])
...
plt.tight_layout()
plt.savefig('scripts/Figures/diag_double_GN.png', dpi=600)
plt.show()
